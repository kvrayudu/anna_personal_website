...
import thesisImage from "./../images/thesisimage.jpg"
import coloringMenuImage from "./../images/coloringmenu.jpg"
...
// COLORING MENU MOVE IMAGE
$("#coloringMenu").mousemove(function(e){
    $("#coloringMenuMovingImg").css({
        "left":e.pageX-300,
         "top": e.pageY+10,
         "display":"block"
      });
  });
  $("#coloringMenu").mouseleave(()=>{
      $("#coloringMenuMovingImg").css({
          "display":"none"
      });
  });
...
return (
    ...
    <div id="digitalSection">
        ...
        <div className="items">
            ...
            <div  id ="thesis">
                <div>
                <a className="projectLink" href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0239766" target="_blank" > Page Design and Sociodemographic Variation in MOOC Enrollment | Thesis</a><br />
                <img src={thesisImage} id="thesisMovingImg"/>
                </div>
            </div>

            <div id ="coloringMenu">
                <div>
                <a className="projectLink" href="http://coloringmenu.com/" target="_blank" > Coloring Menu | Web Art</a><br />
                <img src={coloringMenuImage} id="coloringMenuMovingImg"/>
                </div>
            </div>
            ...
            <div id ="nyt">
                <div>
                <a className="projectLink" href="https://uxdesign.cc/new-york-times-maker-week-2018-whos-reading-557f96898923?gi=d67a1390d557" target="_blank" >Who's Reading?: A Social News Experience | NYT Maker Week</a><br />
            ...
            <div id ="bloomberg">
                <div>
                <a className="projectLink" href="https://medium.com/@annakambhampaty/city-of-syracuse-housing-code-violations-21ba1cbdee98" target="_blank" >Rental Code Violations: UX Research | Bloomberg Innovation Team</a><br />
