            ...
            <Row> 
                  ...
                  <h1 className="sectionHead">Anna Purna Kambhampaty</h1>
                    ...
                    <span className="d-none d-md-block"> 
                      <p>No, not like the motion picture company. Like
                        ...
                        <p>Welcome to my web presence. I'm a writer and programmer based in New York. 
                          I'm currently a styles reporter at <a href="https://www.nytimes.com/by/anna-p-kambhampaty" target="_blank" className= "inlineTextLink"> The New York Times</a>, writing about internet culture, identity, and consumer trends.
                          I've also written for <a href="https://time.com/author/anna-purna-kambhampaty/" target="_blank" className= "inlineTextLink"> TIME Magazine </a>
                           and <a href="https://www.thejuggernaut.com/author/anna-purna-kambhampaty" target="_blank" className= "inlineTextLink"> The Juggernaut</a>. 
                           In the past, I've worked with The New York Times product team, Syracuse's Bloomberg Innovation Team, and CNBC.</p>
                        <p>I'm a graduate of Cornell University, where I was part of 
                          ...
                          <a href="mailto:annakambhampaty@gmail.com?Subject=Hello" target="_top" className="inlineTextLink"> annakambhampaty@gmail.com</a>. 
                        </p>
                    </span>
                  </Col>
                  <Col xs={4}>  
                ...
                <Row>    
                  <Col xs={12} className="makeDisappearAtMedium">
                    ...
                    <p>Welcome to my web presence. I'm a writer and programmer based in New York. I'm currently a styles reporter at <a href="https://www.nytimes.com/by/anna-p-kambhampaty" target="_blank" className= "inlineTextLink"> The New York Times</a>, writing about internet culture, identity, and consumer trends. 
                    I've also written for <a href="https://time.com/author/anna-purna-kambhampaty/" target="_blank" className= "inlineTextLink"> TIME Magazine </a>
                      and <a href="https://www.thejuggernaut.com/author/anna-purna-kambhampaty" target="_blank" className= "inlineTextLink"> The Juggernaut</a>. 
                     In the past, I've worked with The New York Times product team, Syracuse's Bloomberg Innovation Team, and CNBC.</p>
                    <p>I'm a graduate of Cornell University, where I was part of 
